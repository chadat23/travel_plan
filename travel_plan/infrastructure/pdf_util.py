...
def _generate_pdf(travel: Travel) -> PDF:
    ...
    for rp in travel.contacts:
        pdf.add_cell(41, rp.name, 'V', 1, 0, 'L')
        pdf.add_cell(37, rp.email, 'V', 1, 0, 'L')
        pdf.add_cell(37, rp.work_number, 'V', 1, 0, 'L')
        pdf.add_cell(37, rp.home_number, 'V', 1, 0, 'L')
        pdf.add_cell(37, rp.cell_number, 'V', 1, 1, 'L')
    ...
    pdf.add_cell(39, str(travel.gar_avg), 'V', 1, 0, 'C', 1)
    ...
    pdf.add_cell(39, str(travel.mitigated_gar), 'V', 1, 1, 'C', 1)
