...
contact_association_table = db.Table('travel_contact_association', SqlAlchemyBaseTravel.metadata,
...
class Travel(SqlAlchemyBaseTravel):
    ...
    start_date: datetime = db.Column(db.Date, index=True, unique=False, nullable=False)
    ...
    end_date: datetime = db.Column(db.Date, index=True, unique=False, nullable=False)
    ...
    tracked = db.Column(db.Boolean, index=False, unique=False, nullable=True)
    plb = db.Column(db.String, index=False, unique=False, nullable=True)
