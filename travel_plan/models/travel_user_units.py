...
class TravelUserUnit(SqlAlchemyBaseTravel):
    ...
    pack_color_id: str = db.Column(db.String, db.ForeignKey('colors.id'))
    pack_color =db.relationship('Color', foreign_keys=[pack_color_id])
    tent_color_id: str = db.Column(db.String, db.ForeignKey('colors.id'))
    tent_color =db.relationship('Color', foreign_keys=[tent_color_id])
    fly_color_id: str = db.Column(db.String, db.ForeignKey('colors.id'))
